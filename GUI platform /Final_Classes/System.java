...
public class System extends JFrame implements ActionListener {
	...
	public System(List<String> lstProducts) {
		...
		panelDisplayArea.setBorder(new TitledBorder(new BevelBorder(BevelBorder.RAISED), " "));
		...
		areaTxt = new JTextArea("This is the home page!!");
